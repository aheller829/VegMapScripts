...
## Path to AIM GDB ## 
TerrADat_Path <- dsn <- "C:/Users/schalln/OneDrive - New Mexico State University/Desktop/ESDKeys_JWS/AIMEdtBackup3-23-21.gdb/AIMEdtBackup3-23-21.gdb"

## Path to list of accepted ecosite names from EDIT ##
EDIT_List_Path <- "C:/Users/schalln/OneDrive - New Mexico State University/Desktop/ESDKeys_JWS/SiteSummaryTool/defaults/EDIT_public_ecological_site_list.csv"

## Path to Tall Tables created from TerraDat using terradactyl package ##
Tall_Table_Path <- "C:/Users/schalln/OneDrive - New Mexico State University/Desktop/ESDKeys_JWS/ESD_Keys/StateKey_JS/"

## Path to State Key specific to the ecosite ##
StateKeyPath <- "C:/Users/schalln/OneDrive - New Mexico State University/Desktop/ESDKeys_JWS/ESD_Keys/OriginalCode_SiteKey/FullKeys_NotGeneralized/"
StateKeyName <- "Key_R042XB012NM.csv"

## Define EcoSite details ##
## This code relies on sites already being defined by crews/offices ##
EcoSiteName <- "Sandy"
EcologicalSiteId <- EcoSite <- "R042XB012NM"
State_Id <- "NM"
